...
namespace TouchScreen
{
    public class GroupAddress
    {
        public static void ReadAddress(Room room, SQLiteConnection Conn)
        {
            ...
            Control = room.RoomName + "_SpeedCMD";
            room._AC.SpeedCMD_Addr = _addr(Control, Conn);
            Control = room.RoomName + "_Speed";
            room._AC.Speed_Addr = _addr(Control, Conn);
            Control = room.RoomName + "_Fire_Alarm";
            room.FireAlarm_Addr = _addr(Control, Conn);
        }
